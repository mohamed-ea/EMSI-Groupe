...
Route::get('questions/(:num)', array('as'=>'questions', 'uses'=>'questions@ask'));
Route::get('question/(:num)/edit', array('as'=>'edit_question', 'uses'=>'questions@edit'));

Route::get('my-questions', array('as'=>'my-questions', 'uses'=>'questions@my_questions'));
...
Route::get('ask', array('as'=>'ask', 'uses'=>'questions@ask'));
Route::post('ask', array('before'=>'csrf', 'uses'=>'questions@create'));

Route::get('member/(:num)', array('as'=>'member', 'uses'=>'questions@ask'));
